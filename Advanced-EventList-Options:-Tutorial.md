...
###. First, make sure that **S1_Chan** is selected as the active dataset in the Datasets menu (because we are going to re-create the eventless). Then select **EventList > Create EEG EventList.**  
![GUI](./images/Tutorial/Tutorial_Advanced-EventList-Options_1.png)

###. Click the **Advanced** button to open the **Create Advanced EventList** window.
