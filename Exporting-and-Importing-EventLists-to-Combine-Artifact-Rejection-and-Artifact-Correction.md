...
- Import your continuous EEG data into EEGLAB
- Remove "crazy" sections of data from the continuous EEG, either manually or using [Artifact Rejection from - Continuous Data](https://github.com/lucklab/erplab/wiki/Artifact-Rejection-in-Continuous-Data)
- Create an EVENTLIST for the continuous EEG
- Use ICA on the continuous EEG to create an EEG file in which the blinks have been corrected
...
- Epoch and average this corrected EEG file  
